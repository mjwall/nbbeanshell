 ...
 */
class VariableCompletionItem implements CompletionItem {
    ...
    private final ImageIcon variableIcon;

    public VariableCompletionItem(BshVariableInfo variable, int dotOffset, int caretOffset) {
        ...
        Image image = null;
        try {
            image = ImageIO.read(getClass().getResource(variable.getIconPath()));
        } catch (IOException ex) { }
        variableIcon = new ImageIcon(image);
    }
    ...
    public void defaultAction(JTextComponent component) { 
        try {
            ...
            doc.insertString(caretOffset, variable.getName(), null);            
    ...
    public int getPreferredWidth(Graphics g, Font defaultFont) {
        return CompletionUtilities.getPreferredWidth(variable.getName(), null, g, defaultFont);
    }

    @Override
    public void render(Graphics g, Font defaultFont, Color defaultColor, Color backgroundColor, int width, int height, 
                       boolean selected) {
        CompletionUtilities.renderHtml(variableIcon, variable.getName(), null, g, defaultFont,
