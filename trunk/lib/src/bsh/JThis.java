 ...
 * This is a backwards compatability measure for JDK 1.2. With 1.3+ there is a general reflection proxy mechanism that
 * allows the base This to implement arbitrary interfaces.
 *
 * The NameSpace getThis() method will produce instances of JThis if the java version is prior to 1.3 and swing is
 * available... (e.g. 1.2 or 1.1 + swing installed)  *
 ...
 * Note: This module relies on features of Swing and will only compile with JDK1.2 or JDK1.1 + the swing package. For
 * other environments simply do not compile this class.
 */
