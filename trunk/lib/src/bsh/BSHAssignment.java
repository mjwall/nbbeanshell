...
class BSHAssignment extends SimpleNode implements ParserConstants {
    ...
    private Object operation(Object lhs, Object rhs, int kind)
        ...
        /*
         * Implement String += value; According to the JLS, value may be anything. In BeanShell, we'll disallow VOID
         * (undefined) values. (or should we map them to the empty string?)
         */
