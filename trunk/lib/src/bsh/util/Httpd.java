...
/**
 * A very simple httpd that supports the remote server mode. Files are loaded relative to the classpath (as resources).
 *
 * Warning: this is not secure! This server can probably be duped into serving any file on your system! Beware!
 *
...
class HttpdConnection extends Thread {
    ...
    private void serveFile(String file)
        ...
        /*
         * if(file.startsWith("/")) file = file.substring(1); if(file.endsWith("/") || file.equals("")) file = file +
         * "index.html";
         *
         * if(!fileAccessOK(file)) { error(403, "Forbidden"); return; }
         */
