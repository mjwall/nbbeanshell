...
public class ClassBrowser extends JSplitPane
	...
	/*
         * classPath.insureInitialized( null // get feedback on mapping... new ConsoleInterface() { public Reader
         * getIn() { return null; } public PrintStream getOut() { return System.out; } public PrintStream getErr() {
         * return System.err; } public void println( String s ) { System.out.println(s); } public void print( String s )
         * { System.out.print(s); } public void print( String s, Color color ) { print( s ); } public void error( String
         * s ) { print( s ); } } );
         */
    ...
    class PackageTree extends JTree {
        ...
        PackageTree(Collection packages) {
			...
			/*
             * Enumeration e1=root.children(); while( e1.hasMoreElements() ) { TreePath tp = new TreePath(
             * treeModel.getPathToRoot( (TreeNode)e1.nextElement() ) ); expandPath( tp ); }
             */
        }
        ...
        /**
         * Map out the location of the nodes by package name. Seems like we should be able to do this while we build
         * above... I'm tired... just going to do this.
         */
