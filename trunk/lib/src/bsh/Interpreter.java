 ...
 *  (C) 2000. Portions created by Thomas Werner are Copyright (C) 2011. All  *
 *  Rights Reserved.                                                         *
 *                                                                           *
 ...
 *
 * An instance of Interpreter can be used to source scripts and evaluate statements or expressions.  
...
public class Interpreter implements Runnable, ConsoleInterface, Serializable {
     ...
     * conveniences like loose variables, etc. When enabled, variables are required to be declared or initialized 
     * before use and method arguments are reqired to have types.</p>
     * 
    ...
    */
     ...
     * <ol>
     * <li>Parent and child share a BshClassManager</li>
     * <li>Children indicate the parent's source file information in error reporting.</li>
     * </ol>
     * <p>When created as part of a source() / eval() the child also shares the parent's namespace. But that is not 
     * necessary in general.</p>
    */
