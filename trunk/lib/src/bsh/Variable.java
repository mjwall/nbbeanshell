...
public class Variable implements java.io.Serializable {
     ...
     *
     * @param value should be an object or wrapped bsh Primitive type. if value is null the appropriate default value
     * will be set for the type: e.g. false for boolean, zero for integer types.
     */
    public void setValue(Object value, int context)
        ...
        if (lhs != null) {
            lhs.assign(Primitive.unwrap(value), false/*
                     * strictjava
                     */);
            return;
        }
    ...
    /*
     * Note: UtilEvalError here comes from lhs.getValue(). A Variable can represent an LHS for the case of an imported
