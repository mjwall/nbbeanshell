...
class BSHPrimarySuffix extends SimpleNode {
     ...
     *
     * obj will be a Node when suffix evaluation begins, allowing us to interpret it contextually. (e.g. for .class)
     * Thereafter it will be an value object or LHS (as determined by toLHS). <p>
     *
     * We must handle the toLHS case at each point here. <p>
     */
    public Object doSuffix(
        ...
        /*
         * Evaluate our prefix if it needs evaluating first. If this is the first evaluation our prefix mayb be a Node
         * (directly from the PrimaryPrefix) - eval() it to an object. If it's an LHS, resolve to a value.
         *
         * Note: The ambiguous name construct is now necessary where the node may be an ambiguous name. If this becomes
         * common we might want to make a static method nodeToObject() or something. The point is that we can't just
         * eval() - we need to direct the evaluation to the context sensitive type of result; namely object, class, etc.
         */
    ...
    private Object doName(
        ...
        try {
            ...
            try {
                ...
                /*
                 * Try to squeltch the native code stack trace if the exception was caused by a reflective call back
                 * into the bsh interpreter (e.g. eval() or source()
                 */
    ...
    static int getIndexAux(Object obj, CallStack callstack, Interpreter interpreter, SimpleNode callerInfo)
               throws EvalError {
        ...
        int index;
        try {
            Object indexVal = ((SimpleNode) callerInfo.jjtGetChild(0)).eval(callstack, interpreter, null);
    ...
    private Object doProperty(boolean toLHS,Object obj, CallStack callstack, Interpreter interpreter) throws EvalError {
        ...
        Object value = ((SimpleNode) jjtGetChild(0)).eval(callstack, interpreter, null);
