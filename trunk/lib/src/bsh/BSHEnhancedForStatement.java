...
// Just testing...
/**
 * Implementation of the enhanced for(:) statement. This statement uses BshIterable to support iteration over a wide
 * variety of iterable types. Under JDK 1.1 this statement supports primitive and Object arrays, Vectors, and
...
class BSHEnhancedForStatement extends SimpleNode implements ParserConstants {
    ...
    public Object eval(CallStack callstack, Interpreter interpreter, Object resumeStatus) throws EvalError {
        ...
        final Object iteratee = expression.eval(callstack, interpreter, null);
