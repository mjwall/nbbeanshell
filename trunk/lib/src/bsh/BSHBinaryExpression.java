...
/**
 * Implement binary expressions... Note: this is too complicated... need some cleanup and simplification.
 *
...
class BSHBinaryExpression extends SimpleNode
    ...
    public Object eval(CallStack callstack, Interpreter interpreter, Object resumeStatus) throws EvalError {
        ...
        if(kind == INSTANCEOF) {
            ...
            /*
             * // primitive (number or void) cannot be tested for instanceof if (lhs instanceof Primitive) throw new
             * EvalError("Cannot be instance of primitive type." );
             */
            /*
             * Primitive (number or void) is not normally an instanceof anything. But for internal use we'll test true
             * for the bsh.Primitive class. i.e. (5 instanceof bsh.Primitive) will be true
             */
        ...
        Object rhs = ((SimpleNode) jjtGetChild(1)).eval(callstack, interpreter, null);
        ...
        /*
         * Doing the following makes it hard to use untyped vars... e.g. if ( arg == null ) ...what if arg is a
         * primitive? The answer is that we should test only if the var is typed...? need to get that info here...
         *
         * else { // Do we have a mixture of primitive values and non-primitives ? // (primitiveValue = not null, not
         * void)
         *
         * int primCount = 0; if ( isPrimitiveValue( lhs ) ) ++primCount; if ( isPrimitiveValue( rhs ) ) ++primCount;
         *
         * if ( primCount > 1 ) // both primitive types, should have been handled above throw new
         * InterpreterError("should not be here"); else if ( primCount == 1 ) // mixture of one and the other throw new
         * EvalError("Operator: '" + tokenImage[kind] +"' inappropriate for object / primitive combination.", this,
         * callstack );
         *
        ...
        /*
         * Treat lhs and rhs as arbitrary objects and do the operation. (including NULL and VOID represented by their
         * Primitive types)
         */
