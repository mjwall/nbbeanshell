...
public class BshServlet extends HttpServlet {
    ...
    static String getBshVersion() {
        ...
        /*
         * We have included a getVersion() command to detect the version of bsh. If bsh is packaged in the WAR file it
         * could access it directly as a bsh command. But if bsh is in the app server's classpath it won't see it here,
         * so we will source it directly.
         *
    ...
    /*
     * Show context number lines of string before and after target line. Add HTML formatting to bold the target line.
     */
