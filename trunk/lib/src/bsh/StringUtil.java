...
public class StringUtil {
     ...
     *
     * @return String [] { dirName, baseName } public String [] splitFileName( String fileName ) { String dirName,
     * baseName; int i = fileName.lastIndexOf( File.separator ); if ( i != -1 ) { dirName = fileName.substring(0, i);
     * baseName = fileName.substring(i+1); } else baseName = fileName;
     *
