...
/**
 * Remote executor class. Posts a script from the command line to a BshServlet or embedded interpreter using
 * (respectively) HTTP or the bsh telnet service. Output is printed to stdout and a numeric return value is scraped from
 * the result.
 */
public class Remote {
    ...
    /*
     * TODO: this is not unicode friendly, nor is getFile() The output is urlencoded 8859_1 text. should probably be
     * urlencoded UTF-8... how does the servlet determine the encoded charset? I guess we're supposed to add a
     * ";charset" clause to the content type?
     */
    static String doHttp(String postURL, String text) {
        ...
        /*
         * // This requires Java 1.3 try { sb.append( URLEncoder.encode( text, "8859_1" ) ); } catch (
